...
urlpatterns = [
    ...
    path(
        "users/<int:pk>/edit/",
        formviews.EditUserSettingsView.as_view(),
        name="edit_user",
    ),
    path(
        "users/<int:pk>/edit-password/",
        formviews.EditUserPasswordSettingsView.as_view(),
        name="edit_user_password",
    ),
    path(
        "users/<int:pk>/edit-general/",
        formviews.EditUserGeneralSettingsView.as_view(),
        name="edit_user_general",
    ),
    path(
        "users/<int:pk>/edit-crypto/",
        formviews.EditUserCryptoSettingsView.as_view(),
    ...
    path(
        "users/<int:pk>/generate-alternative/",
        views.init_alternative,
        name="init_alternative",
    ),
