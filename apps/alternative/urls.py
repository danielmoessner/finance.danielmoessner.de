...
urlpatterns = [
    ...
    # alternative
    path('alternatives/add/', views.CreateAlternativeView.as_view(), name='add_alternative'),
    path('alternatives/<int:pk>/edit/', views.UpdateAlternativeView.as_view(), name='edit_alternative'),
    path('alternatives/delete/', views.DeleteAlternativeView.as_view(), name='delete_alternative'),
    ...
    path('values/<int:pk>/delete/', views.DeleteValueView.as_view(), name='delete_value'),
    ...
    path('alternatives/<int:pk>/', views.DetailAlternativeView.as_view(), name='alternative'),
]
