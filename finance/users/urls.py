...
urlpatterns = [
    ...
    # alternative
    url(r"^init-alternative/$", views.init_alternative, name="init_alternative"),
    url(r"^(?P<slug>[0-9a-zA-Z@.+_-]*)/set-alternative-depot-active/(?P<pk>\d+)/$",
        login_required(views.set_alternative_depot_active),
